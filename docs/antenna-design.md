...
Bench results matched the model: with C1 empty the card reads at about 1 cm, and the assembled board works end to end, LED included. Write failures were not a coupling problem; NTAG I2C parts ship without a factory NDEF capability container.
